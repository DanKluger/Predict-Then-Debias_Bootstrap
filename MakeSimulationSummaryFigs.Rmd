...
pltExps1to3NoLegend <-  ggarrange(geom_blank(),pltList[[1]],pltList[[2]],pltList[[3]],nrow = 4,labels = c("","AlphaFold with Weighted Sampling (#1)","Housing Price Linear Regression (#2)","Housing Price Quantile Regression (#3)"),heights = c(0.2,1,1,1),font.label = list(size=8.5,face="plain"),vjust = 0.4,hjust=0)
pltExps4to7NoLegend <-  ggarrange(pltList[[4]],pltList[[5]],pltList[[6]],pltList[[7]],nrow = 4,labels = c("Treecover Linear Regression (#4)","Treecover with Clustered Sampling (#5)","Treecover Logistic Regression (#6)","Census with Stratified Sampling (#7)"),font.label = list(size=8.5,face="plain"),vjust = 0.4,hjust=0)
